...
def set_scale(profile="main"):
    ...
    LABEL_FONT_SIZE = int(BASE_LABEL_FONT_SIZE * _scale)
    SECTION_LABEL_FONT_SIZE = int(BASE_SECTION_LABEL_FONT_SIZE * _scale)
    BUTTON_FONT_SIZE = int(BASE_BUTTON_FONT_SIZE * _scale)
    ENTRY_FONT_SIZE = int(BASE_ENTRY_FONT_SIZE * _scale)
    NOTES_FONT_SIZE = int(BASE_NOTES_FONT_SIZE * _scale)
    CONTROL_BTN_FONT_SIZE = int(BASE_CONTROL_BTN_FONT_SIZE * _scale)
